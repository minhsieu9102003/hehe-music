...
// Icons
// ═══════════════════════════════════════════════════
function MusicNoteIcon({ size = 32, color = "#7da08a" }) {
                        ...
                        <div className="pl-page">
                            <div className="pl-header">
                                <div className="pl-header__left">
                                    <MusicNoteIcon size={28} color="#7da08a" />
...
.pl-search:focus-within{border-color:#5d8a72;box-shadow:0 0 0 2px rgba(93,138,114,.12)}
...
.pl-card--add:hover{border-color:#5d8a72;background:#f8fbff;box-shadow:none}
.pl-card--add__inner{display:flex;flex-direction:column;align-items:center;gap:8px;color:#bbb;font-size:13px}
.pl-card--add:hover .pl-card--add__inner{color:#5d8a72}

/* Detail view */
.pl-back{border:none;background:none;color:#5d8a72;font-size:14px;cursor:pointer;padding:0;margin-bottom:16px;font-family:inherit;font-weight:500}
...
.pl-song-row.is-playing{background:#eaf4ee}
.pl-song-row.is-playing .pl-sr-title{color:#5d8a72;font-weight:600}
...
.pl-eq span{width:3px;background:#5d8a72;border-radius:1px;animation:plEq .6s ease-in-out infinite alternate}
...
.pl-player__progress::-webkit-slider-thumb{-webkit-appearance:none;width:12px;height:12px;background:#5d8a72;border-radius:50%;cursor:pointer}
...
.pl-btn--primary{background:#5d8a72;color:#fff}
.pl-btn--primary:hover:not(:disabled){background:#4a7560}
.pl-btn--accent{background:#7da08a;color:#fff}
...
.pl-form__input:focus,.pl-form__textarea:focus{border-color:#5d8a72;box-shadow:0 0 0 2px rgba(93,138,114,.12)}
