...
const NIcon = {
    ...
    Back: ({ s = 16, c = "#5d8a72" }) => <svg width={s} height={s} viewBox="0 0 24 24" fill="none" stroke={c} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 18 9 12 15 6" /></svg>,
};
...
.nt-card.is-active{background:#eaf4ee}
...
.nt-bg-dot:hover{border-color:#5d8a72}
.nt-bg-dot.is-sel{border-color:#5d8a72}
...
.nt-color-dot:hover{border-color:#5d8a72}
...
.nt-editor__content blockquote{border-left:3px solid #5d8a72;padding-left:12px;color:#666;margin:8px 0}
...
.nt-btn--primary{background:#5d8a72;color:#fff}
.nt-btn--primary:hover{background:#4a7560}
